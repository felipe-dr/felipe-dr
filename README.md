...
<table align="center">
  ...
  <tbody>
    <tr>
      <td>
        <br>
        <img src="https://skillicons.dev/icons?i=next,gatsby,react,angular,graphql,ts,js,tailwind,styledcomponents,bootstrap,sass,css,html&theme=light&perline=5" alt="Front-end skills" />
      </td>
      <td>
        <br>
        <img src="https://skillicons.dev/icons?i=nest,nodejs,prisma,postgres,mysql,mongo&theme=light&perline=5" alt="Back-end skills" />
      </td>
      <td>
        <br>
        <img src="https://skillicons.dev/icons?i=jest,vitest,docker,figma,xd,git,github,gitlab,bitbucket,gulp,vscode&theme=light&perline=5" alt="Tools skills" />
      </td>
    </tr>
  </tbody>
</table>
